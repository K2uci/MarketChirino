    ...
    <nav className="bg-black py-4 px-6 fixed w-full top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center space-x-16">
          <a href="/" className="text-green-500 text-2xl font-bold">L'Fashion</a>
        </div>
        ...
        <div className="flex items-center space-x-6">
          ...
          <button className="md:hidden text-white" onClick={handleToch}>
            <Menu className="w-6 h-6" />
            <MobileMenu isOpen={open} onClose={handleToch}/>
          </button>
        </div>
      </div>
    </nav>
